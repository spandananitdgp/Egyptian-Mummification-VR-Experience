This free package contains 30+ ribbon effects created via Shuriken Particle System without non-builtin script (except for the inverted sphere collider in Liberate 3 which was shared for free by someone else). They are good for magical effects like charging and buffing.

These ribbons will look broken when the transformation (position/rotation) of the prefab is animated because the transformation is not taken into account in the calculation of particle spacing interpolation of the sub-emitter. If you agree that the interpolation dreadfully needs improvement, submit bug report ticket to Unity please. Also because of the flaw of Unity's alpha blending mode and particle sorting method, Tornado effects particularly look wonky at certain angle. It's not an issue if your game use fixed or semi-fixed camera angle. But if your game allows free rotation of camera, x-fighting will be very obvious once you pan the camera backward or upward.
